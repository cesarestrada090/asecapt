...
import com.asecapt.app.commons.application.controllers.BaseController;
import com.asecapt.app.commons.util.MapperUtil;
import com.asecapt.app.users.application.dto.LoginRequestDto;
...
import com.asecapt.app.users.infrastructure.email.EmailService;
import com.asecapt.app.users.infrastructure.security.PasswordEncoderUtil;
...
public class UserController extends BaseController {
    ...
    public ResponseEntity<UserResponseDto> updateActiveStatus(@PathVariable("id") Integer id, @RequestBody Map<String, Boolean> body) {
        ...
        UserDto userDto = MapperUtil.map(userEntity, UserDto.class);
