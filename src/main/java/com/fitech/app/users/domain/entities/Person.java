...
public class Person {
    ...
    @JoinTable(name = "person_fitness_goal_type",
            joinColumns = @JoinColumn(name = "person_id"),
            inverseJoinColumns = @JoinColumn(name = "fitness_goal_type_id"))
    private List<FitnessGoalType> fitnessGoalTypes;

    @Column(name = "updated_at")
    private LocalDateTime updatedAt;

    public Person() {
        this.fitnessGoalTypes = new ArrayList<>();
    }
    ...
    public List<FitnessGoalType> getFitnessGoalTypes() {
        return fitnessGoalTypes;
    }

    public void setFitnessGoalTypes(List<FitnessGoalType> fitnessGoalTypes) {
